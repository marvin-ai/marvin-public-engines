# automl_example v0.0.1

## Overview

AutoML example with Marvin
...
```
mkvirtualenv marvin_automl_example_engine_env
```
...
The default log level is set to _WARNING_. You can change the log level at runtime setting another value to one of the following environment variable: `MARVIN_AUTOML_EXAMPLE_ENGINE_LOG_LEVEL` or `LOG_LEVEL`. The available values are _CRITICAL_, _ERROR_, _WARNING_, _INFO_ and _DEBUG_.
